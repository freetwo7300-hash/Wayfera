...
import {
  Plane, Mail, Phone, MapPin, Link,
  Facebook, Twitter, Instagram, Linkedin,
  Youtube, Github, Globe, Music, MessageCircle,
} from 'lucide-react';
import NextLink from 'next/link';
import { ContactInfo, SocialLink } from '@/app/_types';

// Curated map of social icon names → lucide components (replaces `import * as Icons`)
...
export function FooterClient({ contactInfo, socialLinks }: FooterClientProps) {
